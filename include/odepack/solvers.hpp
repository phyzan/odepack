...
Solver<T, N, SP, RhsType, JacType> getSolver(OdeData<RhsType, JacType> ode, T t0, const T* q0, size_t nsys, T rtol, T atol, T min_step=0, T max_step=inf<T>(), T first_step=0, int dir=1, const std::vector<T>& args={}, Extra... extra){
    return Solver<T, N, SP, RhsType, JacType>(ode, t0, q0, nsys, rtol, atol, min_step, max_step, first_step, dir, args, extra...);
}
