...
template<typename Derived, typename T, size_t N, size_t Nstages, size_t Norder, SolverPolicy SP, typename RhsType, typename JacType>
 void RungeKuttaBase<Derived, T, N, Nstages, Norder, SP, RhsType, JacType>::set_coef_matrix_impl() const{
    THIS_C->set_coef_matrix_impl();
}

template<typename Derived, typename T, size_t N, size_t Nstages, size_t Norder, SolverPolicy SP, typename RhsType, typename JacType>
 void RungeKuttaBase<Derived, T, N, Nstages, Norder, SP, RhsType, JacType>::set_coef_matrix() const{
    if (!this->_mat_is_set){
...
template<typename Derived, typename T, size_t N, size_t Nstages, size_t Norder, SolverPolicy SP, typename RhsType, typename JacType>
 std::unique_ptr<Interpolator<T, N>> StandardRungeKutta<Derived, T, N, Nstages, Norder, SP, RhsType, JacType>::state_interpolator(int bdr1, int bdr2) const{
    this->set_coef_matrix();
...
template<typename Derived, typename T, size_t N, size_t Nstages, size_t Norder, SolverPolicy SP, typename RhsType, typename JacType>
 void StandardRungeKutta<Derived, T, N, Nstages, Norder, SP, RhsType, JacType>::interp_impl(T* result, const T& t) const{
    this->set_coef_matrix();
    const T* d = this->interp_new_state_ptr();
...
template<typename T, size_t N, SolverPolicy SP, typename RhsType, typename JacType>
 constexpr typename RK45<T, N, SP, RhsType, JacType>::Base::Ptype RK45<T, N, SP, RhsType, JacType>::Pmatrix() {
...
template<typename T, size_t N, SolverPolicy SP, typename RhsType, typename JacType>
 constexpr typename RK23<T, N, SP, RhsType, JacType>::Base::Ptype RK23<T, N, SP, RhsType, JacType>::Pmatrix() {
