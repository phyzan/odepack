...
int main(){
    ...
    // g++ -std=c++20 -O3 -DDPK_MPREAL -Iinclude -Iexternal/xdiff/include -Iexternal/xdiff/external/lazy/include -Iexternal/polybox/include -Iexternal/ndspan/include tests/variational_test.cpp -o test -lmpfr -lgmp
}