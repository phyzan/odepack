...
def integrate_all(ode_array: Iterable[LowLevelODE], interval, max_frames=-1, event_options: dict[str, tuple[int, bool]|int]={}, threads=-1, max_prints=0):...

def var_integrate_all(varode_array: Iterable[VariationalLowLevelODE], interval: float, lyap_period: float, threads=-1, max_prints=0):...