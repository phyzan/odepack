"""
Base type stubs for ODE solvers - template for backend-specific stubs.

This file contains templated class definitions that are specialized per backend.
Use this as a reference for understanding the template structure.
"""
...
class LowLevelODE(Generic[T]):
    ...
    Template parameter T represents the numeric precision type (float, double, long double, or mpfr::mpreal).
    '''
