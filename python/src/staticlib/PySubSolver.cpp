...
PyRK23::PyRK23(void* solver, PyStruct py_data, ScalarType scalar_type) : PySolver(solver, std::move(py_data), scalar_type) {}
...
PyRK45::PyRK45(void* solver, PyStruct py_data, ScalarType scalar_type) : PySolver(solver, std::move(py_data), scalar_type) {}
...
PyDOP853::PyDOP853(void* solver, PyStruct py_data, ScalarType scalar_type) : PySolver(solver, std::move(py_data), scalar_type) {}
...
PyBDF::PyBDF(void* solver, PyStruct py_data, ScalarType scalar_type) : PySolver(solver, std::move(py_data), scalar_type) {}
...
PyRK4::PyRK4(void* solver, PyStruct py_data, ScalarType scalar_type) : PySolver(solver, std::move(py_data), scalar_type) {}
