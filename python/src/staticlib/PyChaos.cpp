...
#include "../../../include/pyode/lib_impl/PyChaos_impl.hpp"
#include "../../../include/ode/Core/Events_impl.hpp"
...
#define DEFINE_CHAOS(T) \
    template class NormalizationEvent<T>; \
    template class VariationalODE<T, 0, Func<T>, void>;\
    template class VariationalSolver<T, 0, Func<T>, void>;

DEFINE_CHAOS(float)
DEFINE_CHAOS(double)
DEFINE_CHAOS(long double)
#ifdef MPREAL
DEFINE_CHAOS(mpfr::mpreal)
#endif
